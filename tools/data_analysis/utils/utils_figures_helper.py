"""
Helper script for creating figures.
"""
...
def barplot_annotate_brackets(
    ...
    credit to https://stackoverflow.com/questions/11517986/indicating-the-
    statistically-significant-difference-in-bar-graph
    """
...
def add_trial_name_as_number(warm_up_data_df):
    """Add column where trial_name is converted to number and before-/after-correction
    is added."""
